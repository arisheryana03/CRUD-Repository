package com.aries.crudwithretrofit.view.activity;
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (smasuk.equals("")) {
                    ...
                    et_ketmasuk.setError("Silahkan isi value keterangan masuk");
                } else if (sketkeluar.equals("")) {
                    et_ketkeluar.setError("Silahkan isi value keterangan keluar");
                } else {
